#ifndef EVENT_EMIN_INCREMENTAL_TRANSLATION3D_H
#define EVENT_EMIN_INCREMENTAL_TRANSLATION3D_H
...
struct Translation3D
{
  ...
  {
    gMatrix << T(0.0), T(0.0), T(0.0), varst(0), T(0.0), T(0.0), T(0.0),
        varst(1), T(0.0), T(0.0), T(0.0), varst(2), T(0.0), T(0.0), T(0.0),
        T(0.0);
  }
  ...
  {
    const Point ct(t * c);
    pMatrix << t, T(0.0), T(0.0), T(0.0), t, T(0.0), T(0.0), T(0.0), t;
  }
...
template <typename T>
using IncrementalTranslation3D =
    incremental::Model<incremental::Translation3D<T> >;
}  // namespace EventEMin

#endif  // EVENT_EMIN_INCREMENTAL_TRANSLATION3D_H
