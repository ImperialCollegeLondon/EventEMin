#ifndef EVENT_EMIN_INCREMENTAL_ISOMETRY_H
#define EVENT_EMIN_INCREMENTAL_ISOMETRY_H
...
struct Isometry
{
  ...
  {
    gMatrix << T(0.0), -varst(0), varst(1), varst(0), T(0.0), varst(2), T(0.0),
        T(0.0), T(0.0);
  }
  ...
  {
    const Point ct(t * c);
    pMatrix << -ct(1), t, T(0.0), ct(0), T(0.0), t;
  }
...
template <typename T>
using IncrementalIsometry = incremental::Model<incremental::Isometry<T> >;
}  // namespace EventEMin

#endif  // EVENT_EMIN_INCREMENTAL_ISOMETRY_H
